...
def convert_roberta_checkpoint_to_tf(roberta_checkpoint_path, ckpt_dir, model_name):
    """
    Copy/paste/tweak roberta's weights to original BERT structure.
    """
...
def main(raw_args=None):
    ...
    parser.add_argument("--model_name",
                        ...
                        help="model name e.g. roberta_base or roberta_large")
    parser.add_argument("--cache_dir",
                        type=str,
                        default=r'./models/roberta_large_fairseq_torch',
                        help="Directory containing fairseq pytorch model")
    parser.add_argument("--tf_cache_dir",
                        type=str,
                        default=r'./models/roberta_large_fairseq_tf',
